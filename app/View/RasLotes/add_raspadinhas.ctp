...
<div class="card-body">
    ...
    <div class="row">
        ...
        <div class="col-sm-4">
            <div class="form-group">              
                <?php echo $this->Html->link('Gerar Raspadinhas', 'javascript: void(0);', array('class' => 'btn btn-success pull-right', 'escape' => false, 'id' => 'btnSalvar')); ?>
            </div>
        </div>
    </div>
    <hr/>
    ...
    <div class="row">
        <div class="col-sm-12">
            ...
            <?php echo $this->Html->link('Gerar Bilhetes Não Premiados', 'javascript: void(0);', array('class' => 'btn btn-danger pull-right', 'raspadinhas_restantes' => ($lote['RasLote']['qtd_raspadinhas'] - $lote['RasLote']['total_geradas']), 'escape' => false, 'id' => 'btnGerarRaspadinhas')); ?>
            <table class="table table-bordered table-condensed table-striped">
                <tr>
