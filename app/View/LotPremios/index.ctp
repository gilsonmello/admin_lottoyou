<section id="AppLotPremios" <?php echo ($modal == 1) ? 'style="padding:0;"' : '' ?>>
    <div class="section-body" <?php echo ($modal == 1) ? 'style="margin:0;"' : '' ?>>
        <div class="card-head card-head-sm style-primary">
            ...
            <div class="tools">
                <button id="cadastrarLotPremios" type="button" class="btn ink-reaction btn-default-light">
        ...
        <div class="card card-collapsed" style="min-height:500px;">
            ...
            <div class="card-body style-default-light" style="display: none;padding-top:10px;padding-bottom:10px;">
                <?php echo $this->Form->create('search', array('id' => 'pesquisarLotPremios', 'class' => 'form', 'role' => 'form', 'type' => 'get')); ?>
                <div class="row">
            ...
            <div id="gridLotPremios" style="padding: 24px;">
