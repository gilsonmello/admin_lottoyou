<section id="AppLotPrecoQuantidades" <?php echo ($modal == 1) ? 'style="padding:0;"' : '' ?>>
    <div class="section-body" <?php echo ($modal == 1) ? 'style="margin:0;"' : '' ?>>
        <div class="card-head card-head-sm style-primary">
            <header>
                <i class="md md-apps" style="margin-bottom:0;"></i> Loteria
                <i class="md md-navigate-next" style="margin-bottom:0;"></i> <b>Preço Qtds.</b>
            </header>
            <div class="tools">
                ...
                <button id="cadastrarLotPrecoQuantidades" type="button" class="btn ink-reaction btn-default-light">
        ...
        <div class="card card-collapsed" style="min-height:500px;">
            ...
            <div class="card-body style-default-light" style="display: none;padding-top:10px;padding-bottom:10px;">
                <?php echo $this->Form->create('search', array('id' => 'pesquisarLotPrecoQuantidades', 'class' => 'form', 'role' => 'form', 'type' => 'get')); ?>
                <div class="row">
            ...
            <div id="gridLotPrecoQuantidades" style="padding: 24px;">
