<section id="AppBalanceInserts" <?php echo ($modal == 1) ? 'style="padding:0;"' : '' ?>>
    <div class="section-body" <?php echo ($modal == 1) ? 'style="margin:0;"' : '' ?>>
        <div class="card-head card-head-sm style-primary">
            <header>
                <i class="md md-apps" style="margin-bottom:0;"></i> Relatório
                <i class="md md-navigate-next" style="margin-bottom:0;"></i> <b>Saldos inseridos</b>
            </header>
            <div class="tools">
        ...
        <div class="card card-collapsed" style="min-height:500px;">
            ...
            <div id="gridBalanceInserts" style="padding: 24px;">
                ...
                <table id=""
                    ...
                    <?php $total = 0.00; foreach ($dados as $k => $v) { ?>
                        <tr>
                            ...
                            <td>
                                $<?= $v['BalanceInsert']['value']; ?>
                                <?php $total += $v['BalanceInsert']['value']; ?>
                            </td>
                            <td>
                                <?= $v['BalanceInsert']['reason']; ?>
                            </td>
                            <td>
                                <?= $this->Time->format($v['BalanceInsert']['created'], '%d/%m/%Y %H:%M'); ?>
                            </td>
                            <!--<td>
                                <div class="btn-group">
