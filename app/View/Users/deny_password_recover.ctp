    ...
    <div class="card-body">
        <div class="row">
            ...
            <div class="col-sm-8 col-sm-offset-2">
                <br/>
                <span class="text-lg text-bold text-primary"><?php echo Configure::read('Sistema.nome'); ?> | RECUPERAR SENHA DE ACESSO - PASSO 1</span>
                <br/><br/>
                <?php echo $this->Form->create('User', array('id'=>'signup-form', 'class' => 'form floating-label')); ?>
                    <div class="form-group">
                        <?php echo $this->Form->input('username', array('label'=>'Informe seu e-mail para recuperar a senha','class'=>'form-control')); ?>
                    </div>
                    <br/>
                    <div class="row">
