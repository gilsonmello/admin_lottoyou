    ...
    <div class="row">
        <div class="col-sm-6 col-lg-6">
            <div class="form-group">                
                <?php echo $this->Form->input('name', array('label' => 'Nome', 'class' => 'form-control', 'required' => false)); ?>
            </div>
        </div>
        <div class="col-sm-6 col-lg-6">
            <div class="form-group">
                <?php echo $this->Form->input('bank', array('label' => 'Banco', 'class' => 'form-control', 'required' => false)); ?>
            </div>
        </div>
