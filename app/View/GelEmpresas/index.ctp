    ...
    <div class="section-body" <?php echo ($modal == 1)? 'style="margin:0;"' : '' ?>>
        <div class="card-head card-head-sm style-primary">
            <header>
                ...
                <i class="md md-navigate-next" style="margin-bottom:0;"></i> <b>Empresas</b>
            </header>
            <div class="tools">
                ...
                <button id="cadastrarGelEmpresa" type="button" class="btn ink-reaction btn-default-light">
        ...
        <div class="card card-collapsed" style="min-height:500px;">
            ...
            <div class="card-body style-default-light" style="display: none;padding-top:10px;padding-bottom:10px;">
                <?php echo $this->Form->create('search', array('id'=>'pesquisarGelEmpresa','class' => 'form', 'role' => 'form')); ?>
                <div class="row">
                    <div class="col-lg-3">
                        <div class="form-group ">
                            <?php echo $this->Form->input('GelEmpresa.nome', array('label' => 'Nome', 'class' => 'form-control')); ?>
                        </div>
                    </div>
                    <div class="col-lg-3">
                        <div class="form-group ">
                            <?php echo $this->Form->input('GelEmpresa.active', array('label' => 'Ativo', 'options' => array('1'=>'Sim', '0'=>'Não'), 'empty'=>'Todos', 'class' => 'form-control')); ?>
                        </div>
                    </div>
                ...
                <table id=""
                    ...
                    <tbody>
                        <?php foreach ($dados as $k => $v) { ?>
                            <tr>
                                <td><?php echo $v['GelEmpresa']['nome']; ?></td>
                                <td><?php echo $v['GelEmpresa']['razao']; ?></td>
                                <td><?php echo $v['GelEmpresa']['cnpj']; ?></td>
                                <td><label class="label label-<?php echo $v['GelEmpresa']['matriz_label']; ?>"><?php echo $v['GelEmpresa']['matriz_texto']; ?></label></td>
                                <td><label class="label label-<?php echo $v['GelEmpresa']['ativo_label']; ?>"><?php echo $v['GelEmpresa']['ativo']; ?></label></td>
                                <td>
                                    <div class="btn-group">
                                        <button type="button" class="btn btn-icon-toggle dropdown-toggle" data-toggle="dropdown"><i class="fa fa-gear"></i></button>
                                        <ul class="dropdown-menu dropdown-menu-right" role="menu">
                                            <li><?php echo $this->Html->link('<i class="md md-create"></i>&nbsp Editar', 'javascript: void(0)', array("escape" => false, 'id' => $v['GelEmpresa']['id'], 'class' => 'btnEditar')) ?></li>
                                            <li><?php echo $this->Html->link('<i class="md md-delete"></i>&nbsp Excluir', 'javascript: void(0)', array("escape" => false, 'id' => $v['GelEmpresa']['id'], 'class' => 'btnDeletar')) ?></li>
                                            <li style="background: #F1F1F1; font-size: 9px; text-align: center;">Atualizado em: <?php echo @$v['GelEmpresa']['modified'] ?></li>
                                        </ul>
                                    </div>
                                </td>
                            </tr>
