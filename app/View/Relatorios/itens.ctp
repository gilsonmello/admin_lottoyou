<section id="AppRasLotes" <?php echo ($modal == 1) ? 'style="padding:0;"' : '' ?>>
    <div class="section-body" <?php echo ($modal == 1) ? 'style="margin:0;"' : '' ?>>
        ...
        <div class="card card-collapsed" style="min-height:500px;">
            ...
            <div class="card-body style-default-light" style="display: none;padding-top:10px;padding-bottom:10px;">
                <?php echo $this->Form->create('search', array('id' => 'pesquisarRasLote', 'class' => 'form', 'role' => 'form')); ?>
                <div class="row">
                    <div class="col-lg-3">
                        <div class="form-group ">
                            <?php echo $this->Form->input('RasLote.nome', array('label' => 'Nome', 'class' => 'form-control')); ?>
                        </div>
                    </div>
                    <div class="col-lg-3">
                        <div class="form-group">
            ...
            <div id="gridRasLotes" style="padding: 24px;">
                ...
                <table id=""
                    ...
                    <?php foreach ($dados as $k => $v) { ?>
                        <tr>
                            <td><?php echo $v['RasLote']['nome']; ?></td>
                            <td><label class="label label-<?php echo $v['RasLote']['ativo_label']; ?>"><?php echo $v['RasLote']['ativo']; ?></label></td>
                            <td>
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-right" role="menu">
                                        ...
                                        <li style="background: #F1F1F1; font-size: 9px; text-align: center;">Atualizado em: <?php echo @$v['RasLote']['modified'] ?></li>
                                    </ul>
                                </div>
                            </td>
                        </tr>
