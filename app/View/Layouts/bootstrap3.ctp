...
<html lang="pt-br"> 
    <head>
        ...
        echo $this->Html->css('redmond/jquery-ui-1.10.4.min')."\n\t"; 
    ...
    <body style="overflow-y: scroll;">
        ...
        <!-- IMPORTA AQUIVOS JS NECESSÁRIOS -->
        ...
        <?php echo $this->Html->script(array('jquery-ui-1.10.4.min','jquery.idletimer','jquery.idletimeout'))."\n"; ?>
        <?php } ?>
        ...
        <?php echo $this->Html->script('jquery.quicksearch')."\n"; ?>
        <?php echo $this->Html->script('basics')."\n"; ?>
