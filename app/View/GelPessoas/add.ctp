...
<?php echo $this->element('forms/title', array('title' => '<i class="fa fa-plus-square"></i> CADASTRAR Pessoa')); ?>
<div class="card-body">
    <div class="row">
        <div class="col-md-8">
            <?php echo $this->Form->input('tipo_cadastro', array('type' => 'radio', 'legend' => 'Tipo de Cadastro', 'class' => 'radio-inline radio-styled tipo_pessoa', 'options' => $optionsTipoCadastro,'value'=>'C')); ?>
        </div>
    </div>
    <div class="row">
        <div class="col-md-12">
    ...
    <div class="row">
        <div class="col-md-8">
            <?php echo $this->Form->input('tipo_pessoa', array('type' => 'radio', 'legend' => 'Tipo de Pessoa', 'class' => 'radio-inline radio-styled tipo_pessoa', 'options' => array('PF' => 'Pessoa Física', 'PJ' => 'Pessoa Jurícica'),'value'=>'PF')); ?>
        </div>
        <div class="col-sm-4">
    ...
    <div class="row second">
        ...
        <div class="col-sm-4">
            <div class="form-group">                
                <?php echo $this->Form->input('cpf_cnpj', array('label' => 'CPF', 'class' => 'form-control cpf')); ?>
            </div>
        </div>
    </div>
    <div class="row">
            ...
            <div id="accordion1-1" class="collapse" aria-expanded="false">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-sm-7">
                            <div class="form-group">                
                                <?php echo $this->Form->input('gel_cidade_id', array('label' => 'Cidade', 'class' => 'form-control chosen')); ?>
                            </div>
                        </div>
                    </div>                                 
                </div>
