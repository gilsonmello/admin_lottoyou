<section id="AppGelClubes" <?php echo ($modal == 1) ? 'style="padding:0;"' : '' ?>>
    <div class="section-body" <?php echo ($modal == 1) ? 'style="margin:0;"' : '' ?>>
        <div class="card-head card-head-sm style-primary">
            <header>
                <i class="md md-apps" style="margin-bottom:0;"></i> Cadastros 
                <i class="md md-navigate-next" style="margin-bottom:0;"></i> <b>Clubes</b>
            </header>
            <div class="tools">
                ...
                <button id="cadastrarGelClubeCartola" type="button" class="btn ink-reaction btn-default-light">
                    <i class="fa fa-plus-square"></i>
                    Importar do CARTOLA
                </button>
                <button id="cadastrarGelClube" type="button" class="btn ink-reaction btn-default-light">
                    <i class="fa fa-plus-square"></i>
                    Cadastrar
                </button>
            </div>
        ...
        <div class="card card-collapsed" style="min-height:500px;">
            ...
            <div class="card-body style-default-light" style="display: none;padding-top:10px;padding-bottom:10px;">
                <?php echo $this->Form->create('search', array('id' => 'pesquisarGelClube', 'class' => 'form', 'role' => 'form')); ?>
                <div class="row">                    
                    <div class="col-lg-5">
                        <div class="form-group ">
                            <?php echo $this->Form->input('GelClube.nome', array('label' => 'Nome', 'class' => 'form-control')); ?>
                        </div>
                    </div>
                    <div class="col-lg-2">
                        <div class="form-group ">
                            <?php echo $this->Form->input('GelClube.active', array('label' => 'Ativo', 'options' => array('1' => 'Sim', '0' => 'Não'), 'empty' => 'Todos', 'class' => 'form-control')); ?>
                        </div>
                    </div>
                    <div class="col-md-5" style="vertical-align:bottom;">
                        <button type="submit" data-loading-text="<i class='fa fa-spinner fa-spin'></i> Processando..." class="btn ink-reactio/n btn-primary-dark pull-right" style="margin-right: -12px;">
            ...
            <div id="gridGelClube" style="padding: 24px;">
                <!-- RESULTADO DO FILTRO -->
                ...
                <table id=""
                    ...
                    <thead>
                        <tr>
                            ...
                            <th style="width: 10px">Abreviação</th>
                            <th>Nome</th>
                            <th>Ativo</th>
