...
var wordDay_mon = "Segunda";
var wordDay_tue = "Terça";
var wordDay_wed = "Quarta";
var wordDay_thu = "Quinta";
var wordDay_fri = "Sexta";
...
// Calendar Button
var prev_year = "Ant. Ano"
var prev_month = "Ant. Mês"
var next_month = "Prox. Mês"
var next_year = "Prox Ano"
// =======================================================
...
function createCalendar(layout, firstDay, numbDays, monthNum, yearNum) {
    ...
    calendarString += '<tr>';
    if (layout == 'full') {
        calendarString += '<td class=\"calendar-btn\"><span onClick=\"changedate(\'prevyr\', \'full\')\">« <span class="btn-change-date" title ="Ano Anterior">' + prev_year + '<\/span><\/span><\/td>';
        calendarString += '<td class=\"calendar-btn\"><span onClick=\"changedate(\'prevmo\', \'full\')\">« <span class="btn-change-date" title ="Mês Anterior">' + prev_month + '<\/span><\/span><\/td>';
        calendarString += '<td class=\"calendar-title\" colspan=\"3\"><span><i class=\"fa fa-calendar-o\"><\/i>' + wordMonth[monthNum - 1] + '&nbsp;&nbsp;' + yearNum + '<\/span><\/td>';
        calendarString += '<td class=\"calendar-btn\"><span onClick=\"changedate(\'nextmo\', \'full\')\"><span class="btn-change-date" title ="Próximo Mês">' + next_month + '<\/span> »<\/span><\/td>';
        calendarString += '<td class=\"calendar-btn\"><span onClick=\"changedate(\'nextyr\', \'full\')\"><span class="btn-change-date" title ="Próximo Ano">' + next_year + '<\/span> »<\/span><\/td>';
    } else {
...
jQuery(document).ready(function () {
    ...
    jQuery.ajax({
        url: baseUrl + 'avisos/agenda',
        dataType: 'json',
        data: '',
        beforeSend: function () {
            jQuery('.tiva-calendar').html('<div class="loading"><img src="img/loading.gif" /></div>');
        },
