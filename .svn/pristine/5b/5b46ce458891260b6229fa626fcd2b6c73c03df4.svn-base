 ...
 */
	public function input($fieldName, $options = array()) {
		...
		// COMENTEI ESTE CÓDIGO, POIS ESTAVA ATRAPALHANDO A EXIBIÇÃO DOS CAMPOS
 ...
 */
	protected function _getFormat($options) {
		...
		// ALTEREI A POSIÇÃO PADRÃO DA LABEL PARA RODAR COM O TEMPLATE 
		return array('before', 'between', 'input', 'label', 'after', 'error');
	}
	...
	public function radio($fieldName, $options = array(), $attributes = array()) {
		...
		foreach ($options as $optValue => $optTitle) {
			...
			if ($label) {
				...
				$optTitle = '<span>'.$this->label($tagName, $optTitle, $labelOpts).'</span>';
			}
