<section id="AppLotCategorias" <?php echo ($modal == 1)? 'style="padding:0;"' : '' ?>>
    <div class="section-body" <?php echo ($modal == 1)? 'style="margin:0;"' : '' ?>>
        <div class="card-head card-head-sm style-primary">
            ...
            <div class="tools">
                ...
                <button id="cadastrarLotCategoria" type="button" class="btn ink-reaction btn-default-light">
        ...
        <div class="card card-collapsed" style="min-height:500px;">
            ...
            <div class="card-body style-default-light" style="display: none;padding-top:10px;padding-bottom:10px;">
                <?php echo $this->Form->create('search', array('id'=>'pesquisarLotCategoria','class' => 'form', 'role' => 'form')); ?>
                <div class="row">
                    <div class="col-lg-3">
                        <div class="form-group ">
                            <?php echo $this->Form->input('LotCategoria.nome', array('label' => 'Nome', 'class' => 'form-control')); ?>
                        </div>
                    </div>
                    <div class="col-lg-2">
                        <div class="form-group ">
                            <?php echo $this->Form->input('LotCategoria.dezena', array('label' => 'Dezenas', 'class' => 'form-control')); ?>
                        </div>
                    </div>
                    <div class="col-lg-3">
                        <div class="form-group ">
                            <?php echo $this->Form->input('LotCategoria.active', array('label' => 'Ativo', 'options' => array('1'=>'Sim', '0'=>'Não'), 'empty'=>'Todos', 'class' => 'form-control')); ?>
                        </div>
                    </div>
            ...
            <div id="gridLotCategorias" style="padding: 24px;">                
                ...
                <table id=""
                    ...
                    <tbody>
                        <?php foreach ($dados as $k => $v) { ?>
                            <tr>
                                <td><?php echo $v['LotCategoria']['nome']; ?></td>
                                <td><?php echo $v['LotCategoria']['dezena']; ?></td>
                                <td><label class="label label-<?php echo $v['LotCategoria']['ativo_label']; ?>"><?php echo $v['LotCategoria']['ativo']; ?></label></td>
                                <td>
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-right" role="menu">
                                            ...
                                            <li><?php echo $this->Html->link('<i class="md md-delete"></i>&nbsp Excluir', 'javascript: void(0)', array("escape" => false, 'id' => $v['LotCategoria']['id'], 'class' => 'btnDeletar')) ?></li>
                                            <li style="background: #F1F1F1; font-size: 9px; text-align: center;">Atualizado em: <?php echo @$v['LotCategoria']['modified'] ?></li>
                                        </ul>
                                    </div>
                                </td>
                            </tr>
