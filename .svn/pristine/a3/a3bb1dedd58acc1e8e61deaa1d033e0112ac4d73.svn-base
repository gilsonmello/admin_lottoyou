...
<html lang="pt-br">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="<?= $this->Html->url('/'); ?>vendors/bootstrap-3.3.7/dist/css/bootstrap.min.css">
        <?php // echo $this->Html->css('vendors/bootstrap/css/bootstrap.css?1422792965') . "\n\t"; ?>
        <?php echo $this->Html->css('theme-default/materialadmin-site.css?1425466319') . "\n\t"; ?>
    ...
    <body> 
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top navbar-default bg-white">
            <div class="container">
                <div class="navbar-header">
                    <div class="navbar-brand" style=" padding: 0px !important;">
                        <?php echo $this->Html->image('logos/lottoyou-amarelo.png', array('id' => '', 'style' => 'width: 120px')) ?>
                    </div>
                </div>
                <div class="nav navbar-nav navbar-right">
                    <div class="row acoes vcenter">
                        <div class="col-lg-4">
                            <a href="#" class="text-center">Entrar</a>
                        </div>
                        <div class="col-lg-2">
                            |
                        </div>
            ...
            <div class="container-fluid bg-green">
                ...
                <div class="collapse navbar-collapse" id="navbar2">
                    <ul class="nav navbar-nav" style="text-align: center; width: 100%;">
                        <li style="float: none !important; display: inline-block;"><a href="#" class="color-white">Home</a></li>
                        <li style="float: none !important; display: inline-block;"><a href="#" class="color-white">Raspadinha</a></li>
                        <li style="float: none !important; display: inline-block;"><a href="#" class="color-white">Loteria</a></li>
                        <li style="float: none !important; display: inline-block;"><a href="#" class="color-white">Cartola</a></li>
                    </ul>
                </div>
            </div>
        </nav>
        ...
        <!-- BEGIN JAVASCRIPT -->
        <?php echo $this->Html->script('core/libs/jquery/jquery-2.3.js') . "\n"; ?>
        ...
        <script type="text/javascript" src="<?= $this->Html->url('/'); ?>vendors/bootstrap-3.3.7/dist/js/bootstrap.min.js"></script>
