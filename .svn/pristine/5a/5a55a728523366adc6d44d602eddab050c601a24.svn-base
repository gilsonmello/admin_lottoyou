...
<div class="card-body">
    ...
    <div class="row">
        <div class="col-sm-3">
            <div class="form-group">                
                <?php echo $this->Form->input('premio', array('label' => 'Prêmio', 'class' => 'form-control')); ?>
            </div>
        </div>
        <div class="col-sm-3">
            <div class="form-group">                
        ...
        <div class="col-sm-3">
            <div class="form-group">
                <?php echo $this->Form->input('data_fim', array('label' => 'Data de término', 'class' => 'form-control date', 'required'=>false)); ?>
            </div>
        </div>
        <div class="col-sm-3">
            <div class="form-group">
                <?php echo $this->Form->input('hora_fim', array('label' => 'Hora de término', 'class' => 'form-control hora', 'required'=>true)); ?>
            </div>
        </div>
    </div>
</div>
