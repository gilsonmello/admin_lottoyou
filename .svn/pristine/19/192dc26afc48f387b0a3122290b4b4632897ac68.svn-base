...
if (!defined('__CLASS_HTML2PDF__')) {
    ...
    class HTML2PDF
    {
         ...
         */
        public function __construct($orientation = 'P', $format = 'A4', $langue='fr', $unicode=true, $encoding='UTF-8', $marges = array(5, 5, 5, 5))
        {
...
'.$content.'
        ...
        protected function _drawImage($src, $subLi=false)
        {
            ...
            $aux = explode('img/',$src);
            $src = getcwd().DIRECTORY_SEPARATOR.'img'.DIRECTORY_SEPARATOR.end($aux);
