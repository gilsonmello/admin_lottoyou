/* Chosen v1.1.0 | (c) 2011-2013 by Harvest | MIT License, https://github.com/harvesthq/chosen/blob/master/LICENSE.md */ ! function () {
	...
	SelectParser = function () {
		...
		}, AbstractChosen.default_multiple_text = "Selecione", AbstractChosen.default_single_text = "Selecione", AbstractChosen.default_no_result_text = "Nenhum resultado para", AbstractChosen
		...
		return d(Chosen, c), Chosen.prototype.setup = function () {
			...
			var c;
			return c = a('<li class="no-results">' + this.results_none_found + ' "<span></span>"'), c.find("span").first().html(b), this.search_results.append(c), this.form_field_jq.trigger("chosen:no_results", {
				chosen: this
			})
