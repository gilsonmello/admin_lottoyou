...
class Inflector {
    ...
    protected static $_plural = array(
        ...
        'irregular' => array(
            ...
            'foot' => 'feet',
            'motor' => 'motores',
            'frequencias_pre_natal' => 'frequencias_pre_natais',
        )
    );
    ...
    protected static $_singular = array(
        ...
        'irregular' => array(
            'foes' => 'foe',
            'waves' => 'wave',
            'frequencias_pre_natais' => 'frequencias_pre_natal',
            'mulhers' => 'mulher',
            'potencializadores_familiars' => 'potencializadores_familiares'
        )
    );
    ...
    public static function pluralize($word) {
        ...
        if (preg_match('/(.*)\\b(' . self::$_plural['cacheIrregular'] . ')$/i', $word, $regs)) {
            ...
            self::$_cache['pluralize'][$word] = $regs[1] . substr($word, 0, 1) . substr(self::$_plural['merged']['irregular'][$regs[2]], 1);
            return self::$_cache['pluralize'][$word];
        }
    ...
    public static function singularize($word) {
        ...
        if (preg_match('/(.*)\\b(' . self::$_singular['cacheIrregular'] . ')$/i', $word, $regs)) {
            ...
            self::$_cache['singularize'][$word] = $regs[1] . substr($word, 0, 1) . substr(self::$_singular['merged']['irregular'][$regs[2]], 1);
            return self::$_cache['singularize'][$word];
        }
